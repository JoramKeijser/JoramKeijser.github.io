...
So here’s the experiment that Luria conducted, in collaboration with the physisist Max Delbruck. He started by putting single *E. coli* in tubes, and let them replicate until they had grown to large populations. Thanks to *E. coli’s* fast replication times, this took only a day. Then, he added T1 phages to the population, which invariably killed some of the bacteria, while others survived. Crucially though, the number of bacteria that survived varied by several orders of magnitude across different populations. In those with many survivors, T1 resistance must have occurred long before the T1 exposure, rather than in response to the T1 presence. 
...
Did they and all these other classic experiments overlook something? Perhaps, but several alternative explanations seem more relevant. 
...
The goal here is to determine the conditions under which the selective advantage of mutational bias is strong enough for it to evolve. Here, I summarise my understanding of the argument. For more information please see the papers from [Lynch et al.](https://www.nature.com/articles/nrg.2016.104), [Chen & Zhang](https://doi.org/10.1093/molbev/mst060), and Extended Data Fig. 10 from [Monroe et al.](https://doi.org/10.1038/s41586-021-04269-6)).  
