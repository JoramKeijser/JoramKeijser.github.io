...
Here, we will investigate why textbooks still teach that evolution works through random mutations, 
but also why this might change in the light of recent experiments. First, we need to review the general role of mutations 
...
<span class="caption" STYLE="font-size:85%"> (a) Mutation rates are larger for organisms with a large genome, (b) But even the mammalian replication machinery is so accurate that it could copy the Kandel without any errors. (a) From Futuyma & Kirkpatrick, *Evolution*, 4th edition. </span>
