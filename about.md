...
I'm a PhD student in computational neuroscience supervised by Prof. [Henning Sprekeler](https://www.sprekelerlab.org/), funded by the [TU Berlin](https://www.tu.berlin/) and [ECN Berlin](https://www.ecn-berlin.de/). I'm fascinated by the brain's ability to solve hard computational problems that are beyond even the best computer algorithms. To understand neural computation, I analyze neural activity from behaving animals and I train artificial neural networks on similar tasks. I also study how the brain evolved, by comparing patterns of gene expression in different species, ranging from humans to turtles.\
Besides science, I co-organize the [WWNeuRise seminar](https://neurise.github.io/) for early career researchers, and teach at BCCN Berlin's [Master Program Computational Neuroscience](https://www.bccn-berlin.de/master-program.html). Previously, I obtained a MSc in mathematics from [Leiden University](https://www.universiteitleiden.nl/). Outside of the lab, I'm a voracious reader and a less-than-voracious runner.  
